...
const MetricsSection = () => {
  ...
  return (
    <section
      className="relative py-24 space-y-10  bg-black  overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col md:flex-row md:items-center gap-12">
        ...
        <div className="w-full md:w-1/2 space-y-10">
          ...
          <a
            href="#"
            className="ml-10 px-4 py-2 font-bold sm:px-3 sm:py-3   w-full max-w-65 text-base sm:text-lg bg-gradient-to-r from-red-500 to-red-500 text-white rounded-2xl shadow-lg hover:opacity-90 transition flex items-center justify-center"
          >
        ...
        <div className="w-full md:w-1/2 flex justify-center">
          ...
          >
            <div className="mx-12">
              <span className="font-medium text-2xl md:text-6xl text-white">
